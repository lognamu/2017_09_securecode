		...
		<form>
			<table cellpadding="5">
				...
				<tbody>
					<tr>
						<th>이름</th>
						<td><input type="text" id="name" name="name" placeholder="2~5글자 입력"></td>
					</tr>
					<tr>
						<th>국어점수</th>
						<td><input type="text" id="korean" name="korean" placeholder="0~100사이, 숫자만 입력"></td>
					</tr>
					<tr>
						<th>영어점수</th>
						<td><input type="text" id="english" name="english" placeholder="0~100사이, 숫자만 입력"></td>
					</tr>
					<tr>
						<th>수학점수</th>
						<td><input type="text" id="math" name="math" placeholder="0~100사이, 숫자만 입력"></td>
					</tr>
				</tbody>
				<tfoot>
					<tr>
